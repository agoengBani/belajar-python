...
frame_nama_obat.grid(row=0, column=1, sticky='nsew', columnspan=4)
Label(frame_nama_obat, text="Id Dapil", width=10).pack()

frame_nama_obat = Frame(root, relief="solid", borderwidth=1)
frame_nama_obat.grid(row=0, column=1, sticky='nsew', columnspan=4)
Label(frame_nama_obat, text="Dapil", width=10).pack()

frame_jenis_obat = Frame(root, relief="solid", borderwidth=1)
frame_jenis_obat.grid(row=1, column=1, sticky='nsew')
Label(frame_jenis_obat, text="Nama Dapil", width=30).pack()

frame_jenis_obat = Frame(root, relief="solid", borderwidth=1)
frame_jenis_obat.grid(row=1, column=2, sticky='nsew')
Label(frame_jenis_obat, text="Wilayah", width=15).pack()

frame_jenis_obat = Frame(root, relief="solid", borderwidth=1)
frame_jenis_obat.grid(row=1, column=3, sticky='nsew')
Label(frame_jenis_obat, text="Jumlah Kursi", width=15).pack()

frame_jenis_obat = Frame(root, relief="solid", borderwidth=1)
frame_jenis_obat.grid(row=1, column=4, sticky='nsew')
...
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=2, column=2, sticky='nsew')
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=2, column=3, sticky='nsew')
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=2, column=4, sticky='nsew')
...
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=3, column=2, sticky='nsew')
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=3, column=3, sticky='nsew')
Entry(root, width=18, relief="solid", borderwidth=1).grid(row=3, column=4, sticky='nsew')
